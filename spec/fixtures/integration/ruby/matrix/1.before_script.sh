...
test -f $HOME/.casher/bin/casher && casher-ruby $HOME/.casher/bin/casher fetch http://localhost:3001/test/pull-request/rvm-2.0.0-gemfile.tgz http://localhost:3001/master/rvm-2.0.0-gemfile.tgz || true
