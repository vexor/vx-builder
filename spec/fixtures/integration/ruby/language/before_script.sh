...
test -f $HOME/.casher/bin/casher && casher-ruby $HOME/.casher/bin/casher fetch http://localhost:3001/test/pull-request/rvm-default-gemfile.tgz http://localhost:3001/master/rvm-default-gemfile.tgz || true
