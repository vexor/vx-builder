...
test -f $HOME/.casher/bin/casher && casher-ruby $HOME/.casher/bin/casher fetch http://example.com/test/pull-request/rvm-default-gemfile.tgz http://example.com/master/rvm-default-gemfile.tgz || true
